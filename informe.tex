...
\begin{titlepage}
    \centering
    {\scshape\LARGE Universidad Nombre \par}
    {\scshape\Large Facultad de Ingeniería \par}
    {\scshape\large Asignatura: INFO1155 \par}
    \vspace{2cm}
    {\Huge\bfseries Procesamiento de Audio WAV: Extracción y Reconstrucción de Canal Derecho\par}
    \vspace{1.5cm}
    {\Large Informe Final\par}
    \vspace{2cm}
    {\large Autor(es): Nombre(s) del/los autor(es)\par}
    {\large Profesor: Nombre del profesor\par}
    {\large Fecha: 1 de mayo de 2025\par}
    \vfill
    \includegraphics[width=0.3\textwidth]{logo.png} % Si tienes un logo, si no, elimina esta línea
    \vfill
\end{titlepage}

\begin{center}
\textbf{Universidad} \\ Facultad de Ingeniería \\ Asignatura: INFO1155 \\ Profesor: [Nombre del profesor] \\ 
\end{center}
\vspace{2cm}
